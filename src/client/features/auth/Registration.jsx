          ...
          >
            {({ isSubmitting }) => (
              <Form className="w-75 mx-auto">
                ...
                <div className="form-group">
                  <Field type="password" name="passwordConfirmation" className="form-control form-control-lg" placeholder="Потверждение пароля" />
                  <ErrorMessage name="passwordConfirmation" component={customError} />
                </div>
                ...
                <div className="form-group ">
                  <button type="submit" className="btn btn-primary w-100" disabled={isSubmitting}>Зарегистрировать</button>
                </div>
                {registrationError && (
